...
<nav className="navbar navbar-expand-md navbar-light bg-secondary sticky-top">
  <div className="container-fluid">
      <a href="#a" className="navbar-brand w-25"><img src={logo} className="rounded-circle w-25" alt="logo" /></a>
      ...
      <div id="navbarResponsive" className="collapse navbar-collapse">
          <ul className="navbar-nav ml-auto">
              ...
              <li className="navbar-item">
                  <a href="#a" className="nav-link text-light">Ofertas</a>
              </li>
              <li className="navbar-item">
                  <a href="#a" className="nav-link text-light">Nosotros</a>
              </li>
          </ul>
      </div>
  </div>
